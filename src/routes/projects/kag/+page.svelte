...
<div class="mx-auto mt-28 max-w-6xl px-4">
	<div class="mb-6 flex w-full flex-col items-center gap-8 md:flex-row md:items-start">
		<!-- Project Card -->
		<div class="rounded-md bg-slate-200 p-4 md:max-w-xs">
			...
			<div id="links" class="py-2">
				...
				<a
					...
					href="https://kag.marcose.eu"
					target="_blank"
					rel="noopener noreferrer">kag.marcose.eu</a
				>
				<br />
		...
		<div>
			...
			<p class="py-2">
				...
				history each week. The creators of the podcast often refer to the concept of the "patchwork
				quilt of history" and their goal of weaving together stories from different times and places
				to gain a better understanding of historical events and the context in which they occurred.
			</p>
			<p class="py-2">
				...
				projects where I could try both implementing and running a data pipeline with Apache Airflow
				and a more complex, but most importantly fun and inspiring Sveltekit app, everything fell
				into place.
			</p>
			<p class="py-2">
	...
	<div class="mb-6">
		...
		<p class="py-2">
			The main element of the website is the interactive world map on which every location that was
			mentioned in one of the podcast episodes is marked on. It allows you to zoom in and out, drag
			the map to different places and hover over the markers to see the location and all the
	...
	<div class="mb-6">
		...
		<p class="py-2">
			...
			put my data engineering skills to good use, as well channeling my creative energy and furhter
			improving on my frontend web development skills.
		</p>
		<p class="py-2">
			The rough technical architecture can be seen on the graph below. I will talk a bit about each
			part and my takeaways working with them in the following sections
		</p>
	...
	<div class="mb-6">
		...
		<ol class="my-2 list-inside list-decimal">
			<li>
				<span class="my-1 underline">Database Setup:</span> On the initial run of the pipeline this step
				creates the required database and tables, which will store the gathered data and serve the webserver
				lateron.
			</li>
			<li>
			...
			<li>
				<span class="my-1 underline">Cleaning: </span>This step removes unwanted formatting from the
				summary text, removes advertisment and extracts the Episode-ID from the title.
			</li>
			<li>
				<span class="my-1 underline">Entity Extraction:</span> Here I make use of NLP techniques to extract
				the locations mentioned from the available texts.
			</li>
			<li>
				<span class="my-1 underline">Data Enrichment:</span> Finally I use an external API Service to
				receive coordinates for the location name, which can be drawn onto the map.
			</li>
		</ol>

		<p class="py-2">
			The features Apache Airflow brings out of the box are amazing, but lead to it not being as
			lightweight as I hoped it to be. Additionally the main role of as a simple "job scheduler" was
			not clear to me in the beginning and I probably implemented more logic inside of Airflow Tasks
			than I should have. The setup using the available Docker Images was easily done and the
			provided UI and Monitoring capabilities intuitive to use. Working with and deploying a
	...
	<div class="mb-6">
		...
		<p class="py-2">
			I chose SvelteKit after working with Vue and React in the past, and will most likely continue
			to use it for the foreseeable future as it has proven to be very developer friendly, well
			documented, flexible, and powerful. Given the project structure of SvelteKit in combination
	...
	<div class="mb-6">
		...
		<p class="py-2">
			I went for the extra mile at the beginning of development and "dockerized" the entire project
			by creating custom Docker Images for each component. Currently I use Docker Compose for both
			local development and hosting on a linux webserver. This ensures cloud portability and makes
			me independent of hosting and developing environments. Deploying a Kubernetes Cluster, which
			allows for easy scaling of the user-facing components, can easily be done when needed based on
